...
KBDCR           .EQ     $C001           ;PIA.A keyboard control register
DSP             .EQ     $C000           ;PIA.B display output register
DSPCR           .EQ     $C001           ;PIA.B display control register
...
;-------------------------------------------------------------------------
                ...
                .DA     $0000           ;Unused, what a pity (WOZ is refering to User Interrupt)
