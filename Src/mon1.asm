...
KBD             EQU     $C000           ;PIA.A keyboard input
KBDCR           EQU     $C001           ;PIA.A keyboard control register
DSP             EQU     $C000           ;PIA.B display output register
DSPCR           EQU     $C001           ;PIA.B display control register
...
;-------------------------------------------------------------------------
                ...
                DS     $0000           ;Unused, what a pity (WOZ is refering to User Interrupt)
NMI_VEC         DS     $0F00           ;NMI vector
RESET_VEC       DS     RESET           ;RESET vector
IRQ_VEC         DS     $0000           ;IRQ vector
