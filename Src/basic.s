...
STRNG2:
	defs 2
CHRGET:
TXTPTR equ (GENERIC_TXTPTR-GENERIC_CHRGET + CHRGET) & 0xff
CHRGOT equ (GENERIC_CHRGOT-GENERIC_CHRGET + CHRGET) & 0xff
CHRGOT2 equ (GENERIC_CHRGOT2-GENERIC_CHRGET + CHRGET) & 0xff
RNDSEED equ (GENERIC_RNDSEED-GENERIC_CHRGET + CHRGET) & 0xff
...
ERROR_MESSAGES:
ERR_NOFOR equ ($-ERROR_MESSAGES) & 0xff
        .db "NF"
ERR_SYNTAX equ ($-ERROR_MESSAGES) & 0xff
        .db "SN"
ERR_NOGOSUB equ ($-ERROR_MESSAGES) & 0xff
        .db "RG"
ERR_NODATA equ ($-ERROR_MESSAGES) & 0xff
        .db "OD"
ERR_ILLQTY equ ($-ERROR_MESSAGES) & 0xff
        .db "FC"
ERR_OVERFLOW equ ($-ERROR_MESSAGES) & 0xff
        .db "OV"
ERR_MEMFULL equ ($-ERROR_MESSAGES) & 0xff
        .db "OM"
ERR_UNDEFSTAT equ ($-ERROR_MESSAGES) & 0xff
        .db "US"
ERR_BADSUBS equ ($-ERROR_MESSAGES) & 0xff
        .db "BS"
ERR_REDIMD equ ($-ERROR_MESSAGES) & 0xff
        .db "DD"
ERR_ZERODIV equ ($-ERROR_MESSAGES) & 0xff
        .db "/0"
ERR_ILLDIR equ ($-ERROR_MESSAGES) & 0xff
        .db "ID"
ERR_BADTYPE equ ($-ERROR_MESSAGES) & 0xff
        .db "TM"
ERR_STRLONG equ ($-ERROR_MESSAGES) & 0xff
        .db "LS"
ERR_FRMCPX equ ($-ERROR_MESSAGES) & 0xff
        .db "ST"
ERR_CANTCONT equ ($-ERROR_MESSAGES) & 0xff
        .db "CN"
ERR_UNDEFFN equ ($-ERROR_MESSAGES) & 0xff
        .db "UF"
...
StartupMessage:
	.db	$0C,"Cold [C] or warm [W] start?",$0D,$0A,$00
